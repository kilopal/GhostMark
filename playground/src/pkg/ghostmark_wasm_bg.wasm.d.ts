...
export const strip_odt_metadata_wasm: (a: number, b: number) => [number, number, number, number];
export const strip_pdf_metadata_wasm: (a: number, b: number) => [number, number, number, number];
export const strip_svg_metadata_wasm: (a: number, b: number) => [number, number, number, number];
